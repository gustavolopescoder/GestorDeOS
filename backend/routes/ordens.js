...
router.get("/", async (req, res) => {
  const { empresa_id, tecnico_id } = req.query; // pega os parâmetros da URL
...
// Rota para criar nova ordem (POST)
router.post("/", async (req, res) => {
  ...
  try {
    const result = await db.query(
      ...
      (empresa_id, tecnico_id, hora_inicio, hora_fim, local, data_inicio, data_fim, solicitado, prestado, data_criacao)
